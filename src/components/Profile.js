      ...
      <div className="container">
        ...
        <div className={styles.aboutGrid}>
          ...
          <div className={styles.statsCol}>
            ...
            <div className={styles.statCard}>
              <span className={styles.statIcon}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="10" rx="2" ry="2"></rect><line x1="6" y1="22" x2="6" y2="17"></line><line x1="18" y1="22" x2="18" y2="17"></line><line x1="12" y1="22" x2="12" y2="17"></line></svg>
              </span>
              <div className={styles.statVal}>
